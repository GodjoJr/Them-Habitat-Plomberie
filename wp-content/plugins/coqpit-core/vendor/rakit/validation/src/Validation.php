...
namespace COQPIT\Core\Vendor\Rakit\Validation;

use Closure;
use COQPIT\Core\Vendor\Rakit\Validation\Rules\Interfaces\BeforeValidate;
use COQPIT\Core\Vendor\Rakit\Validation\Rules\Interfaces\ModifyValue;
use COQPIT\Core\Vendor\Rakit\Validation\Rules\Required;
...
class Validation
{
     ...
     * Constructor
     *
     * @param \COQPIT\Core\Vendor\Rakit\Validation\Validator $validator
     * @param array $inputs
     * @param array $rules
     ...
     *
     * @param string $attributeKey
     * @return null|\COQPIT\Core\Vendor\Rakit\Validation\Attribute
     */
     ...
     *
     * @return \COQPIT\Core\Vendor\Rakit\Validation\ErrorBag
     */
     ...
     * Validate attribute
     *
     * @param \COQPIT\Core\Vendor\Rakit\Validation\Attribute $attribute
     * @return void
     */
     ...
     * @param \COQPIT\Core\Vendor\Rakit\Validation\Attribute $attribute
     * @param mixed $value
     * @param \COQPIT\Core\Vendor\Rakit\Validation\Rule $ruleValidator
     * @return void
     */
     ...
     *
     * @param \COQPIT\Core\Vendor\Rakit\Validation\Attribute $attribute
     * @param \COQPIT\Core\Vendor\Rakit\Validation\Rule $rule
     * @return bool
     */
     ...
     * @param \COQPIT\Core\Vendor\Rakit\Validation\Attribute $attribute
     * @param mixed $value
     * @param \COQPIT\Core\Vendor\Rakit\Validation\Rule $validator
     * @return mixed
     */
     ...
     *
     * @return \COQPIT\Core\Vendor\Rakit\Validation\Validator
     */
