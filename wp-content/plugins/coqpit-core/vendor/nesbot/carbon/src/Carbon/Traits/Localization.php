...
namespace COQPIT\Core\Vendor\Carbon\Traits;

use COQPIT\Core\Vendor\Carbon\CarbonInterface;
use COQPIT\Core\Vendor\Carbon\Exceptions\InvalidTypeException;
use COQPIT\Core\Vendor\Carbon\Exceptions\NotLocaleAwareException;
use COQPIT\Core\Vendor\Carbon\Language;
use COQPIT\Core\Vendor\Carbon\Translator;
use COQPIT\Core\Vendor\Carbon\TranslatorStrongTypeInterface;
use Closure;
use COQPIT\Core\Vendor\Symfony\Component\Translation\TranslatorBagInterface;
use COQPIT\Core\Vendor\Symfony\Component\Translation\TranslatorInterface;
use COQPIT\Core\Vendor\Symfony\Contracts\Translation\LocaleAwareInterface;
use COQPIT\Core\Vendor\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;

// @codeCoverageIgnoreStart
if (interface_exists('COQPIT\\Core\\Vendor\\Symfony\\Contracts\\Translation\\TranslatorInterface') &&
    !interface_exists('COQPIT\\Core\\Vendor\\Symfony\\Component\\Translation\\TranslatorInterface')
) {
    class_alias(
        'COQPIT\\Core\\Vendor\\Symfony\\Contracts\\Translation\\TranslatorInterface',
        'COQPIT\\Core\\Vendor\\Symfony\\Component\\Translation\\TranslatorInterface'
    );
}
...
trait Localization
{
     ...
     * Default translator.
     *
     * @var \COQPIT\Core\Vendor\Symfony\Component\Translation\TranslatorInterface
     */
     ...
     *
     * @return \COQPIT\Core\Vendor\Symfony\Component\Translation\TranslatorInterface
     */
     ...
     *
     * @param \COQPIT\Core\Vendor\Symfony\Component\Translation\TranslatorInterface $translator
     *
     * @return void
     */
     ...
     *
     * @param \COQPIT\Core\Vendor\Symfony\Component\Translation\TranslatorInterface $translator the translator to use
     ...
     * @param string|null                                        $locale     current locale used if null
     * @param string|null                                        $default    default value if translation returns the key
     * @param \COQPIT\Core\Vendor\Symfony\Component\Translation\TranslatorInterface $translator an optional translator to use
     *
     * @return string
     */
     ...
     * @param \COQPIT\Core\Vendor\Symfony\Component\Translation\TranslatorInterface|null $translator
     ...
     * @param \COQPIT\Core\Vendor\Symfony\Component\Translation\MessageCatalogueInterface $catalogue
     *
     * @return mixed
     */
