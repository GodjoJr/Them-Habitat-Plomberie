...
use COQPIT\Core\Vendor\Carbon\Exceptions\EndLessPeriodException;
...
use COQPIT\Core\Vendor\Carbon\Exceptions\InvalidPeriodDateException;
use COQPIT\Core\Vendor\Carbon\Exceptions\InvalidPeriodParameterException;
use COQPIT\Core\Vendor\Carbon\Exceptions\NotACarbonClassException;
use COQPIT\Core\Vendor\Carbon\Exceptions\NotAPeriodException;
use COQPIT\Core\Vendor\Carbon\Exceptions\UnknownGetterException;
use COQPIT\Core\Vendor\Carbon\Exceptions\UnknownMethodException;
use COQPIT\Core\Vendor\Carbon\Exceptions\UnreachableException;
...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
     ...
     *
     * @param \COQPIT\Core\Vendor\Carbon\Carbon|\COQPIT\Core\Vendor\Carbon\CarbonPeriod|\COQPIT\Core\Vendor\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return bool
     */
     ...
     *
     * @param \COQPIT\Core\Vendor\Carbon\CarbonPeriod|\DatePeriod|string $period
     *
     * @return bool
     */
     ...
     * @SuppressWarnings(PHPMD.UnusedFormalParameter)
     *
     * @param \COQPIT\Core\Vendor\Carbon\Carbon $current
     * @param int            $key
     *
     * @return bool|string
     */
     ...
     * @param \COQPIT\Core\Vendor\Carbon\Carbon|\COQPIT\Core\Vendor\Carbon\CarbonPeriod|\COQPIT\Core\Vendor\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return \COQPIT\Core\Vendor\Carbon\CarbonInterface
     */
