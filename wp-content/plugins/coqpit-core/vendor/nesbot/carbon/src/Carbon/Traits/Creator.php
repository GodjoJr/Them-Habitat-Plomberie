...
use COQPIT\Core\Vendor\Carbon\Carbon;
use COQPIT\Core\Vendor\Carbon\CarbonImmutable;
use COQPIT\Core\Vendor\Carbon\CarbonInterface;
use COQPIT\Core\Vendor\Carbon\Exceptions\InvalidDateException;
use COQPIT\Core\Vendor\Carbon\Exceptions\InvalidFormatException;
...
trait Creator
{
    ...
    public static function rawCreateFromFormat($format, $time, $tz = null)
    {
        ...
        /** @var \COQPIT\Core\Vendor\Carbon\CarbonImmutable|\COQPIT\Core\Vendor\Carbon\Carbon|null $mock */
     ...
     * @param \COQPIT\Core\Vendor\Symfony\Component\Translation\TranslatorInterface $translator optional custom translator to use for macro-formats
     *
     * @throws InvalidFormatException
     *
     * @return static|false
