...
use COQPIT\Core\Vendor\Carbon\Exceptions\BadFluentConstructorException;
use COQPIT\Core\Vendor\Carbon\Exceptions\BadFluentSetterException;
use COQPIT\Core\Vendor\Carbon\Exceptions\InvalidCastException;
use COQPIT\Core\Vendor\Carbon\Exceptions\InvalidIntervalException;
use COQPIT\Core\Vendor\Carbon\Exceptions\OutOfRangeException;
use COQPIT\Core\Vendor\Carbon\Exceptions\ParseErrorException;
use COQPIT\Core\Vendor\Carbon\Exceptions\UnitNotConfiguredException;
use COQPIT\Core\Vendor\Carbon\Exceptions\UnknownGetterException;
use COQPIT\Core\Vendor\Carbon\Exceptions\UnknownSetterException;
use COQPIT\Core\Vendor\Carbon\Exceptions\UnknownUnitException;
use COQPIT\Core\Vendor\Carbon\Traits\IntervalRounding;
use COQPIT\Core\Vendor\Carbon\Traits\IntervalStep;
use COQPIT\Core\Vendor\Carbon\Traits\MagicParameter;
use COQPIT\Core\Vendor\Carbon\Traits\Mixin;
use COQPIT\Core\Vendor\Carbon\Traits\Options;
use COQPIT\Core\Vendor\Carbon\Traits\ToStringFormat;
use Closure;
use DateInterval;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
     ...
     *
     * @throws \COQPIT\Core\Vendor\Carbon\Exceptions\ParseErrorException when the $interval cannot be parsed as an interval.
     *
     * @return static
     */
    ...
    public function forHumans($syntax = null, $short = false, $parts = -1, $options = null)
    {
        ...
        /** @var \COQPIT\Core\Vendor\Symfony\Component\Translation\Translator $translator */
