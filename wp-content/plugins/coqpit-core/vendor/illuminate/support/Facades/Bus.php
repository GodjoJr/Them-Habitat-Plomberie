...
use COQPIT\Core\Vendor\Illuminate\Contracts\Bus\Dispatcher as BusDispatcherContract;
use Illuminate\Foundation\Bus\PendingChain;
use COQPIT\Core\Vendor\Illuminate\Support\Testing\Fakes\BusFake;
 ...
 * @method static \Illuminate\Bus\PendingBatch batch(\COQPIT\Core\Vendor\Illuminate\Support\Collection|array|mixed $jobs)
 * @method static \Illuminate\Foundation\Bus\PendingChain chain(\COQPIT\Core\Vendor\Illuminate\Support\Collection|array $jobs)
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Testing\Fakes\BusFake except(array|string $jobsToDispatch)
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Testing\Fakes\ChainedBatchTruthTest chainedBatch(\Closure $callback)
 * @method static void assertBatched(callable $callback)
 * @method static void assertBatchCount(int $count)
 * @method static void assertNothingBatched()
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Collection dispatched(string $command, callable|null $callback = null)
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Collection dispatchedSync(string $command, callable|null $callback = null)
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Collection dispatchedAfterResponse(string $command, callable|null $callback = null)
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Collection batched(callable $callback)
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Testing\Fakes\BusFake serializeAndRestore(bool $serializeAndRestore = true)
 *
 * @see \Illuminate\Bus\Dispatcher
 * @see \COQPIT\Core\Vendor\Illuminate\Support\Testing\Fakes\BusFake
 */
class Bus extends Facade
{
     ...
     * @return \COQPIT\Core\Vendor\Illuminate\Support\Testing\Fakes\BusFake
     */
