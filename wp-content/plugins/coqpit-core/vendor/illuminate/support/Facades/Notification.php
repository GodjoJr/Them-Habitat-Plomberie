...
use COQPIT\Core\Vendor\Illuminate\Support\Testing\Fakes\NotificationFake;

/**
 * @method static void send(\COQPIT\Core\Vendor\Illuminate\Support\Collection|array|mixed $notifiables, mixed $notification)
 * @method static void sendNow(\COQPIT\Core\Vendor\Illuminate\Support\Collection|array|mixed $notifiables, mixed $notification, array|null $channels = null)
 ...
 * @method static \Illuminate\Notifications\ChannelManager setContainer(\COQPIT\Core\Vendor\Illuminate\Contracts\Container\Container $container)
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Collection sent(mixed $notifiable, string $notification, callable|null $callback = null)
 * @method static bool hasSent(mixed $notifiable, string $notification)
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Testing\Fakes\NotificationFake serializeAndRestore(bool $serializeAndRestore = true)
 ...
 * @see \COQPIT\Core\Vendor\Illuminate\Support\Testing\Fakes\NotificationFake
 */
class Notification extends Facade
{
     ...
     *
     * @return \COQPIT\Core\Vendor\Illuminate\Support\Testing\Fakes\NotificationFake
     */
