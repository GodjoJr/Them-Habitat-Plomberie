...
/**
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Filesystem\Filesystem drive(string|null $name = null)
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Filesystem\Filesystem disk(string|null $name = null)
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Filesystem\Cloud cloud()
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Filesystem\Filesystem build(string|array $config)
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Filesystem\Filesystem createLocalDriver(array $config)
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Filesystem\Filesystem createFtpDriver(array $config)
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Filesystem\Filesystem createSftpDriver(array $config)
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Filesystem\Cloud createS3Driver(array $config)
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Filesystem\Filesystem createScopedDriver(array $config)
 ...
 * @method static \Illuminate\Filesystem\FilesystemManager setApplication(\COQPIT\Core\Vendor\Illuminate\Contracts\Foundation\Application $app)
 * @method static bool exists(string $path)
 * @method static string|null get(string $path)
 * @method static resource|null readStream(string $path)
 * @method static bool put(string $path, \COQPIT\Core\Vendor\Psr\Http\Message\StreamInterface|\Illuminate\Http\File|\Illuminate\Http\UploadedFile|string|resource $contents, mixed $options = [])
