...
use COQPIT\Core\Vendor\Illuminate\Support\Testing\Fakes\QueueFake;
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Queue\Queue connection(string|null $name = null)
 ...
 * @method static \Illuminate\Queue\QueueManager setApplication(\COQPIT\Core\Vendor\Illuminate\Contracts\Foundation\Application $app)
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Queue\Job|null pop(string|null $queue = null)
 * @method static string getConnectionName()
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Queue\Queue setConnectionName(string $name)
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Testing\Fakes\QueueFake except(array|string $jobsToBeQueued)
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Collection pushed(string $job, callable|null $callback = null)
 * @method static bool hasPushed(string $job)
 * @method static bool shouldFakeJob(object $job)
 * @method static array pushedJobs()
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Testing\Fakes\QueueFake serializeAndRestore(bool $serializeAndRestore = true)
 *
 * @see \Illuminate\Queue\QueueManager
 * @see \Illuminate\Queue\Queue
 * @see \COQPIT\Core\Vendor\Illuminate\Support\Testing\Fakes\QueueFake
 */
class Queue extends Facade
{
     ...
     * @return \COQPIT\Core\Vendor\Illuminate\Support\Testing\Fakes\QueueFake
     */
