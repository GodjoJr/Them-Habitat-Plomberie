 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\ServiceProvider register(\COQPIT\Core\Vendor\Illuminate\Support\ServiceProvider|string $provider, bool $force = false)
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\ServiceProvider|null getProvider(\COQPIT\Core\Vendor\Illuminate\Support\ServiceProvider|string $provider)
 * @method static array getProviders(\COQPIT\Core\Vendor\Illuminate\Support\ServiceProvider|string $provider)
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\ServiceProvider resolveProvider(string $provider)
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Foundation\MaintenanceMode maintenanceMode()
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Container\ContextualBindingBuilder when(array|string $concrete)
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Container\Container|\Illuminate\Foundation\Application setInstance(\COQPIT\Core\Vendor\Illuminate\Contracts\Container\Container|null $container = null)
