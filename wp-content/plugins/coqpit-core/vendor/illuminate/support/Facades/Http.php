 ...
 * @method static \COQPIT\Core\Vendor\GuzzleHttp\Promise\PromiseInterface response(array|string|null $body = null, int $status = 200, array $headers = [])
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Collection recorded(callable $callback = null)
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Events\Dispatcher|null getDispatcher()
 ...
 * @method static \Illuminate\Http\Client\PendingRequest withBody(\COQPIT\Core\Vendor\Psr\Http\Message\StreamInterface|string $content, string $contentType = 'application/json')
 ...
 * @method static \COQPIT\Core\Vendor\GuzzleHttp\Client buildClient()
 * @method static \COQPIT\Core\Vendor\GuzzleHttp\Client createClient(\COQPIT\Core\Vendor\GuzzleHttp\HandlerStack $handlerStack)
 * @method static \COQPIT\Core\Vendor\GuzzleHttp\HandlerStack buildHandlerStack()
 * @method static \COQPIT\Core\Vendor\GuzzleHttp\HandlerStack pushHandlers(\COQPIT\Core\Vendor\GuzzleHttp\HandlerStack $handlerStack)
 * @method static \Closure buildBeforeSendingHandler()
 * @method static \Closure buildRecorderHandler()
 * @method static \Closure buildStubHandler()
 * @method static \COQPIT\Core\Vendor\GuzzleHttp\Psr7\RequestInterface runBeforeSendingCallbacks(\COQPIT\Core\Vendor\GuzzleHttp\Psr7\RequestInterface $request, array $options)
 * @method static array mergeOptions(array ...$options)
 * @method static \Illuminate\Http\Client\PendingRequest stub(callable $callback)
 * @method static \Illuminate\Http\Client\PendingRequest async(bool $async = true)
 * @method static \COQPIT\Core\Vendor\GuzzleHttp\Promise\PromiseInterface|null getPromise()
 * @method static \Illuminate\Http\Client\PendingRequest setClient(\COQPIT\Core\Vendor\GuzzleHttp\Client $client)
...
class Http extends Facade
{
     ...
     *
     * @param  string  $url
     * @param  \Illuminate\Http\Client\Response|\COQPIT\Core\Vendor\GuzzleHttp\Promise\PromiseInterface|callable  $callback
     * @return \Illuminate\Http\Client\Factory
     */
