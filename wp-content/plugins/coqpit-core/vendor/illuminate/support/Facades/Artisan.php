...
use COQPIT\Core\Vendor\Illuminate\Contracts\Console\Kernel as ConsoleKernelContract;

/**
 * @method static int handle(\Symfony\Component\Console\Input\InputInterface $input, \Symfony\Component\Console\Output\OutputInterface|null $output = null)
 * @method static void terminate(\Symfony\Component\Console\Input\InputInterface $input, int $status)
 * @method static void whenCommandLifecycleIsLongerThan(\DateTimeInterface|\COQPIT\Core\Vendor\Carbon\CarbonInterval|float|int $threshold, callable $handler)
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Carbon|null commandStartedAt()
