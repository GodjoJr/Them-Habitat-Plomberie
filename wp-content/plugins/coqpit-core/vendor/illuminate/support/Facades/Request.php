 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Session\Session session()
 * @method static void setLaravelSession(\COQPIT\Core\Vendor\Illuminate\Contracts\Session\Session $session)
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Stringable str(string $key, mixed $default = null)
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Stringable string(string $key, mixed $default = null)
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Carbon|null date(string $key, string|null $format = null, string|null $tz = null)
 * @method static object|null enum(string $key, string $enumClass)
 * @method static \COQPIT\Core\Vendor\Illuminate\Support\Collection collect(array|string|null $key = null)
