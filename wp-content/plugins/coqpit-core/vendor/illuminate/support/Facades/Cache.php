...
/**
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Cache\Repository store(string|null $name = null)
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Cache\Repository driver(string|null $driver = null)
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Cache\Repository resolve(string $name)
 * @method static \Illuminate\Cache\Repository repository(\COQPIT\Core\Vendor\Illuminate\Contracts\Cache\Store $store)
 ...
 * @method static \Illuminate\Cache\CacheManager setApplication(\COQPIT\Core\Vendor\Illuminate\Contracts\Foundation\Application $app)
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Cache\Store getStore()
 * @method static \Illuminate\Cache\Repository setStore(\COQPIT\Core\Vendor\Illuminate\Contracts\Cache\Store $store)
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Events\Dispatcher getEventDispatcher()
 * @method static void setEventDispatcher(\COQPIT\Core\Vendor\Illuminate\Contracts\Events\Dispatcher $events)
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Cache\Lock lock(string $name, int $seconds = 0, string|null $owner = null)
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Cache\Lock restoreLock(string $name, string $owner)
 *
