...
/**
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\View\View file(string $path, \COQPIT\Core\Vendor\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\View\View make(string $view, \COQPIT\Core\Vendor\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\View\View first(array $views, \COQPIT\Core\Vendor\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderWhen(bool $condition, string $view, \COQPIT\Core\Vendor\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderUnless(bool $condition, string $view, \COQPIT\Core\Vendor\Illuminate\Contracts\Support\Arrayable|array $data = [], array $mergeData = [])
 * @method static string renderEach(string $view, array $data, string $iterator, string $empty = 'raw|')
 * @method static bool exists(string $view)
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\View\Engine getEngineFromPath(string $path)
 ...
 * @method static void setContainer(\COQPIT\Core\Vendor\Illuminate\Contracts\Container\Container $container)
 ...
 * @method static void startComponent(\COQPIT\Core\Vendor\Illuminate\Contracts\View\View|\COQPIT\Core\Vendor\Illuminate\Contracts\Support\Htmlable|\Closure|string $view, array $data = [])
 ...
 * @method static void callComposer(\COQPIT\Core\Vendor\Illuminate\Contracts\View\View $view)
 * @method static void callCreator(\COQPIT\Core\Vendor\Illuminate\Contracts\View\View $view)
