 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Process\ProcessResult run(array|string|null $command = null, callable|null $output = null)
 ...
 * @method static \Illuminate\Process\Factory recordIfRecording(\Illuminate\Process\PendingProcess $process, \COQPIT\Core\Vendor\Illuminate\Contracts\Process\ProcessResult $result)
 * @method static \Illuminate\Process\Factory record(\Illuminate\Process\PendingProcess $process, \COQPIT\Core\Vendor\Illuminate\Contracts\Process\ProcessResult $result)
 ...
 * @method static \COQPIT\Core\Vendor\Illuminate\Contracts\Process\ProcessResult pipe(callable|array $callback, callable|null $output = null)
