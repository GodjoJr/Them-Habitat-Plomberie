...
use COQPIT\Core\Vendor\Carbon\Factory;
 ...
 *
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon createFromDate($year = null, $month = null, $day = null, $tz = null)
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon|false createFromFormat($format, $time, $tz = null)
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon createFromTime($hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon createFromTimeString($time, $tz = null)
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon createFromTimestamp($timestamp, $tz = null)
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon createFromTimestampMs($timestamp, $tz = null)
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon createFromTimestampUTC($timestamp)
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon createMidnightDate($year = null, $month = null, $day = null, $tz = null)
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon|false createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)
 ...
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon fromSerialized($value)
 ...
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon|null getTestNow()
 * @method \COQPIT\Core\Vendor\Symfony\Component\Translation\TranslatorInterface getTranslator()
 ...
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon instance($date)
 ...
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon|null make($var)
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon maxValue()
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon minValue()
 * @method void mixin($mixin)
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon now($tz = null)
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon parse($time = null, $tz = null)
 ...
 * @method void setTranslator(\COQPIT\Core\Vendor\Symfony\Component\Translation\TranslatorInterface $translator)
 ...
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon today($tz = null)
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon tomorrow($tz = null)
 ...
 * @method \COQPIT\Core\Vendor\Illuminate\Support\Carbon yesterday($tz = null)
 */
class DateFactory
{
    /**
