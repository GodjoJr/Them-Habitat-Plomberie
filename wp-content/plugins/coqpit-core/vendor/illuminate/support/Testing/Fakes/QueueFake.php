...
use Closure;
use COQPIT\Core\Vendor\Illuminate\Contracts\Queue\Queue;
...
class QueueFake extends QueueManager implements Fake, Queue
{
     ...
     *
     * @var \COQPIT\Core\Vendor\Illuminate\Contracts\Queue\Queue
     */
    public $queue;
     ...
     *
     * @var \COQPIT\Core\Vendor\Illuminate\Support\Collection
     */
     ...
     *
     * @param  \COQPIT\Core\Vendor\Illuminate\Contracts\Foundation\Application  $app
     ...
     *
     * @param  string|null  $queue
     * @return \COQPIT\Core\Vendor\Illuminate\Contracts\Queue\Job|null
     */
