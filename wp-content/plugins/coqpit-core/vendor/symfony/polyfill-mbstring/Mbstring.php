...
namespace COQPIT\Core\Vendor\Symfony\Polyfill\Mbstring;
...
final class Mbstring
{
    ...
    public static function mb_internal_encoding($encoding = null)
    {
        ...
        throw new \COQPIT_Core_VendorValueErrorValueError;
    }
    ...
    private static function assertEncoding(string $encoding, string $errorFormat): void
    {
        ...
        } catch (\COQPIT_Core_VendorValueErrorValueError\ValueError(\sprintf($errorFormat, $encoding));
        }

        // BC for PHP 7.3 and lower
        if (!$validEncoding) {
            throw new \COQPIT_Core_VendorValueErrorValueError\sprintf($errorFormat, $encoding));
        }
    }
}
