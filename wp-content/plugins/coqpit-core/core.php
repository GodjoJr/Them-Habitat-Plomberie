<?php
/**
 * Plugin Name: COQPIT - Core
 * Description: Ajoute et modifie certaines fonctionnalités de WordPress.
 * Version: 1.2.1
 * Author: COQPIT - Agence Digitale
 * Author URI: https://www.coqpit.fr
 * Text Domain: coqpit-core
...
define('COQPIT_CORE_VERSION', '1.0.0');
define('COQPIT_CORE_PATH', plugin_dir_path(__FILE__));
define('COQPIT_CORE_URI', plugin_dir_url(__FILE__));
define('COQPIT_CORE_PLUGIN_FILE', __FILE__ );
...
// Init Core requirements and methods
\COQPIT\Plugins\Core\Core::init();
